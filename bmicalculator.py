...
def interpret_bmi(bmi):
    ...
    if bmi < 18.5: 
        ...
        return f"Your BMI is {bmi}, you are obese (Class 1)."
    elif bmi < 39.9:
        return f"Your BMI is {bmi}, you are obese (Class 2)."
    else:
        return f"Your BMI is {bmi}, you are obese (Class 3)."
...
def main():
    try:
        ...
        print("Invalid input. Please enter proper numeric values for height and weight.")
